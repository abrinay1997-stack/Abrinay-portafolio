      ...
      {activeModal && (
        ...
        >
          ...
          >
            <button
              onClick={() => setActiveModal(null)}
              className="absolute top-6 right-6 text-white/40 hover:text-[#cc4e00] transition-colors uppercase text-[12px] font-mono tracking-[0.2em] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#cc4e00] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0a] rounded-sm"
            >
              Cerrar [X]
            </button>
            <h3 id="legal-modal-title" className="font-cinematic text-lg text-white mb-8 tracking-[0.15em] uppercase border-l-2 border-[#cc4e00] pl-6">
      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12 mb-32 max-w-4xl mx-auto">
          {SOCIAL_LINKS.map(link => (
            <a
              ...
              className="group relative flex items-center justify-center w-14 h-14 rounded-full border border-white/10 bg-white/0 hover:bg-white/5 hover:border-[#cc4e00]/60 transition-all duration-500 transform hover:scale-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#cc4e00] focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505]"
              title={link.name}
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-[12px] text-white/60 uppercase tracking-[0.2em] gap-12 pt-20 border-t border-white/10">
          ...
          <div className="flex gap-12 md:gap-16 font-bold">
            ...
            <button onClick={() => setActiveModal('privacy')} className="hover:text-[#cc4e00] transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#cc4e00] focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505] rounded-sm">Privacidad</button>
            <button onClick={() => setActiveModal('index')} className="hover:text-[#cc4e00] transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#cc4e00] focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505] rounded-sm">Índice</button>
          </div>
        </div>
      </div>
    </footer>
